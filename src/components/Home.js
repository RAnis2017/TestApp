        ...
        >
          <div className="row justify-content-center fullview">
            <div className="col-lg-4 align-self-center text-center">
              <h1 className="heading-max font-secondary home-heading"><span className="font-accent">P</span>repare. <br /><span className="font-accent"> E</span>valuate.<br /><span className="font-accent"> S</span>ucceed!</h1>
